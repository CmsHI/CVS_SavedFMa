...
process.HLTHcalSimpleRecHitFilter.threshold = 3
process.HLTHcalSimpleRecHitFilter.minNHitsNeg = 2
process.HLTHcalSimpleRecHitFilter.minNHitsPos = 2
process.HLTHcalSimpleRecHitFilter.doCoincidence = True
