...
void MetPlotAllCent5BinConeDphi3StackMC(char *inputFile="data.root")
{
   ...
   drawText("In Cone |#Delta R|<0.8",0.33,0.66);
   ...
   c1->SaveAs("missingPtParallel-Cone08-dphi3-Corrected-MCAllGenParticle-allCent.eps");
   c1->SaveAs("missingPtParallel-Cone08-dphi3-Corrected-MCAllGenParticle-allCent.gif");
