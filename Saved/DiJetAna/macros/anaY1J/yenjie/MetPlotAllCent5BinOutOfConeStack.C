...
void MetPlotAllCent5BinOutOfConeStack(char *inputFile="data.root")
{
   ...
   c1->SaveAs("missingPtParallel-OutOfCone08-CorrectedDataComparedToMC-allCent.eps");
   c1->SaveAs("missingPtParallel-OutOfCone08-CorrectedDataComparedToMC-allCent.gif");
