...
void MetPlotInConeOutConeDPhiCutv2MC(char *inputFile="data.root")
{
   ...
   balanceMetVsAj("./ntv2deadforpix_dj_HyUQ80v3_djcalo_100_50.root","cent<30","metConex",false);
...
//   drawText("#intL dt = 6.7 #mub^{-1}",0.33,0.78);
   ...
   balanceMetVsAj("./ntv2deadforpix_dj_HyUQ80v3_djcalo_100_50.root","cent<30","metOutOfConex",false);
   drawText("Out-of-Cone",0.7,0.93);
   drawText("#DeltaR#geq0.8",0.7,0.93-0.06);
   drawText("(d)",0.04,0.95);
   
   c1->SaveAs("missingPtParallel-Corrected-MC-InConeOutConeDPhiCut.eps");
   c1->SaveAs("missingPtParallel-Corrected-MC-InConeOutConeDPhiCut.gif");
}
