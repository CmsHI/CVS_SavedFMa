...
void MetPlotAllCent5BinConeStack(char *inputFile="data.root")
{
   ...
   c1->SaveAs("missingPtParallel-Cone08-CorrectedDataComparedToMC-allCent.eps");
   c1->SaveAs("missingPtParallel-Cone08-CorrectedDataComparedToMC-allCent.gif");
