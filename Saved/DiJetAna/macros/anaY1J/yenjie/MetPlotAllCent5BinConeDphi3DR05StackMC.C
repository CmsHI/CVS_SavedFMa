		    ...
		    )
{
   ...
   // Selection cut
   TCut evtCut = "nljet>120&&abs(nljetacorr)<2&&aljet>50&&abs(aljetacorr)<2&&jdphi>3.0&&!maskEvt";
...
void MetPlotAllCent5BinConeDphi3DR05StackMC(char *inputFile="data.root")
{
   ...
   drawText("In Cone |#Delta R|<0.5",0.33,0.66);
   ...
   c1->SaveAs("missingPtParallel-Cone05-dphi3-Corrected-MCAllGenParticle-allCent.eps");
   c1->SaveAs("missingPtParallel-Cone05-dphi3-Corrected-MCAllGenParticle-allCent.gif");
