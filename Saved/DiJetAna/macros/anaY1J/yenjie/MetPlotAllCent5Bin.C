...
void MetPlotAllCent5Bin(char *inputFile="data.root")
{
   ...
   c1->cd(1);
   balanceMetVsAj("nt_dj_mix100_Gen08.root","cent>=30","",false,false);
...
//   balanceMetVsAj("nt_dj_mix120_Gen_frank.root","cent>=30","",false,false);
   ...
   c1->cd(2);
   balanceMetVsAj("nt_dj_mix100_Gen08.root","cent<30","",true,false);
...
//   balanceMetVsAj("nt_dj_mix120_Gen_frank.root","cent<30","",true,false);
   ...
   c1->cd(3);
   balanceMetVsAj("nt_dj_data100_cor08.root","cent>=30","",false);
