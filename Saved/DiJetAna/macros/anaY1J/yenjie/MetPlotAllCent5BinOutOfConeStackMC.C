...
void MetPlotAllCent5BinOutOfConeStackMC(char *inputFile="data.root")
{
...
//   balanceMetVsAj("nt_dj_HyUQ80v4_djcalo_genp_100_50.root","cent<30","",false);
   ...
   c1->SaveAs("missingPtParallel-OutOfCone08-Corrected-MCAllGenParticle-allCent.eps");
   c1->SaveAs("missingPtParallel-OutOfCone08-Corrected-MCAllGenParticle-allCent.gif");
