...
void anaJetFrag(
    ...
    TString inFile0Name = "dj_HCPR-J50U-hiGoodMergedTracks_OfficialSelv2_Final0_djcalo_100_50.root",
    Bool_t doEvtSel = false,
    Bool_t doEtaCorr = true,
    Bool_t doReWeight = true,
    ...
    TString DJCutType = "Ana") // Ana
{
  ...
  jana.cut.NrJEtaMax = 2; // 2, 1.6
  jana.cut.AwJEtaMax = 2; // 2, 1.6
