		    ...
		    )
{
   ...
   // Selection cut
   //TCut evtCut = "nljet>120&&abs(nljetacorr)<1&&aljet>50&&abs(aljetacorr)<2&&jdphi>2./3*TMath::Pi()&&!maskEvt";
...
void MetPlotAllCent5BinConeDphi3Stack(char *inputFile="data.root")
{
   ...
   drawText("|#Delta R|<0.8",0.33,0.74);
   ...
   c1->SaveAs("missingPtParallel-Cone08-dphi3-CorrectedDataComparedToMC-allCent.eps");
   c1->SaveAs("missingPtParallel-Cone08-dphi3-CorrectedDataComparedToMC-allCent.gif");
