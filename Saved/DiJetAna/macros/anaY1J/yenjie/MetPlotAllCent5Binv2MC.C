...
void MetPlotAllCent5Binv2MC(char *inputFile="data.root")
{
   ...
   balanceMetVsAj("./ntv2_dj_HyUQ80v3_djcalo_100_50.root","cent>=30","",false);
   ...
   c1->SaveAs("missingPtParallel-Corrected-MC-allCent.eps");
   c1->SaveAs("missingPtParallel-Corrected-MC-allCent.gif");
}
