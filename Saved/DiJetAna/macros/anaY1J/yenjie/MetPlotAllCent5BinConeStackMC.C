...
void MetPlotAllCent5BinConeStackMC(char *inputFile="data.root")
{
   ...
   c1->SaveAs("missingPtParallel-Cone08-Corrected-MCAllGenParticle-allCent.eps");
   c1->SaveAs("missingPtParallel-Cone08-Corrected-MCAllGenParticle-allCent.gif");
