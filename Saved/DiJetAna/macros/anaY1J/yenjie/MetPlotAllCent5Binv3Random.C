		    ...
		    )
{
   ...
   t->SetAlias("metxMerged0","(metOutOfConex0+metOutOfConex1+metOutOfConex2+metOutOfConex3)");
   t->SetAlias("metxMerged1","(metOutOfConex1+metOutOfConex2+metOutOfConex3)");
   t->SetAlias("metxMerged2","(metOutOfConex2+metOutOfConex3)");
   ...
   // Selection cut
   TCut evtCut = "nljet>120&&abs(nljetacorr)<1.6&&aljet>50&&abs(aljetacorr)<1.6&&acos(cos(nljphi-aljphi))>5./6*TMath::Pi()&&!maskEvt";
...
void MetPlotAllCent5Binv3Random(char *inputFile="data.root")
{
   ...
   balanceMetVsAj("ntv5_data50v2mix1.root","cent<30","",false);
   drawText("CMS",0.33,0.90);
   drawText("Pb+Pb  #sqrt{s}_{_{NN}}=2.76 TeV",0.33,0.84);
   drawText("Random cone (Jet sample)",0.33,0.78);
   drawText("0-30%",0.85,0.93);
   float pty1(0.4);
   ...
   c1->cd(4);
   //balanceMetVsAj("nt_dj_data100_cor.root","cent<30","",false);
   balanceMetVsAj("./ntv5_datambv3mix1_djcalo_c0to30.root","cent<30","",false);
   //balanceMetVsAj("./ntv5_datambv3randphi.root","cent<30","",false);
   drawText("0-30%",0.8,0.93);
   drawText("Random Cone (MB Sample)",0.33,0.78);
   drawText("(d)",0.04,0.95);
   gPad->RedrawAxis();
   
   c1->SaveAs("missingPtParallel-Corrected-OutOfCone-dataRandomJetMB-allCent.eps");
   c1->SaveAs("missingPtParallel-Corrected-OutOfCone-dataRandomJetMB-allCent.gif");
}
