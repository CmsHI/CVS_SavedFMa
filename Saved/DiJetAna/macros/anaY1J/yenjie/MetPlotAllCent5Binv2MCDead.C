...
void MetPlotAllCent5Binv2MCDead(char *inputFile="data.root")
{
   ...
   balanceMetVsAj("./ntv2_dj_HyUQ80v3_djcalo_genp_100_50.root","cent>=30","",false,false);
   ...
   balanceMetVsAj("./ntv2_dj_HyUQ80v3_djcalo_genp_100_50.root","cent<30","",true,false);
   ...
   balanceMetVsAj("./ntv2deadforpix_dj_HyUQ80v3_djcalo_100_50.root","cent>=30","",false);
   drawText("CMS",0.33,0.90);
   drawText("PYTHIA+HYDJET Reco",0.33,0.84);
//   drawText("#intL dt = 6.7 #mub^{-1}",0.33,0.78);
   ...
   c1->SaveAs("missingPtParallel-Corrected-MC-DeadPixel-allCent.eps");
   c1->SaveAs("missingPtParallel-Corrected-MC-DeadPixel-allCent.gif");
}
