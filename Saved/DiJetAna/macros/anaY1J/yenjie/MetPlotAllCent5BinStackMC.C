...
void MetPlotAllCent5BinStackMC(char *inputFile="data.root")
{
   TCanvas *c1 = new TCanvas("c1","",1000,1000);
   Float_t leftMargin=0.28,bottomMargin=0.18;
   makeMultiPanelCanvas(c1,2,2,0.0,0.0,leftMargin,bottomMargin,0.02);
   c1->cd(1);
   balanceMetVsAj("nt_dj_mix100_Gen_05.root","cent>=30","",false,false);
   ...
   c1->cd(2);
   balanceMetVsAj("nt_dj_mix100_Gen_05.root","cent<30","",true,false);
   ...
   c1->SaveAs("missingPtParallel-CompareMC-Corrected-MC-allCent.eps");
   c1->SaveAs("missingPtParallel-CompareMC-Corrected-MC-allCent.gif");
