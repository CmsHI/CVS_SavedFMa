...
void MetPlotAllCent5BinOutOfConeDphi3Stack(char *inputFile="data.root")
{
   ...
   c1->SaveAs("missingPtParallel-OutOfCone08-dphi3-CorrectedDataComparedToMC-allCent.eps");
   c1->SaveAs("missingPtParallel-OutOfCone08-dphi3-CorrectedDataComparedToMC-allCent.gif");
