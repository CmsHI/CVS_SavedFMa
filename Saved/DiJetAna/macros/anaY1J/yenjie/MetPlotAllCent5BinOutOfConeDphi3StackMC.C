...
void MetPlotAllCent5BinOutOfConeDphi3StackMC(char *inputFile="data.root")
{
   TCanvas *c1 = new TCanvas("c1","",1000,1000);
   Float_t leftMargin=0.28,bottomMargin=0.18;
   makeMultiPanelCanvas(c1,2,2,0.0,0.0,leftMargin,bottomMargin,0.02);
   c1->cd(1);
   balanceMetVsAj("nt_dj_HyUQ80v4_djcalo_genp_100_50.root","cent>=30","",false,false);

   drawText("PYTHIA+HYDJET",0.33,0.82);
   drawText("All Genparticles",0.33,0.74);
   drawText("Out of Cone |#Delta R|>0.8",0.33,0.66);
   ...
   c1->cd(2);
   balanceMetVsAj("nt_dj_HyUQ80v4_djcalo_genp_100_50.root","cent<30","",true,false);
...
//   balanceMetVsAj("nt_dj_HyUQ80v4_djcalo_genp_100_50.root","cent<30","",false);
   ...
   c1->SaveAs("missingPtParallel-OutOfCone08-dphi3-Corrected-MCAllGenParticle-allCent.eps");
   c1->SaveAs("missingPtParallel-OutOfCone08-dphi3-Corrected-MCAllGenParticle-allCent.gif");
