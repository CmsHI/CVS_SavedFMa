...
void MetPlotInConeOutConeAllDPhiCut(char *inputFile="data.root")
{
   //=============================================================
   // MC
   //=============================================================
   ...
   drawText("#DeltaR #geq 0.8",0.7,0.9-0.06);

   c1->cd(3);
   balanceMetVsAj("nt_dj_mix100_Gen.root","cent<30","",false,false);
   drawText("All",0.8,0.9);
   ...
   drawText("#DeltaR #geq 0.8",0.7,0.93-0.06);
   
   c1->cd(6);
   balanceMetVsAj("nt_dj_data100_cor.root","cent<30","",false);
   drawText("All",0.8,0.93);
   
   c1->SaveAs("missingPtParallel-Corrected-data-InConeOutConeAllDPhiCut.eps");
   c1->SaveAs("missingPtParallel-Corrected-data-InConeOutConeAllDPhiCut.gif");
}
