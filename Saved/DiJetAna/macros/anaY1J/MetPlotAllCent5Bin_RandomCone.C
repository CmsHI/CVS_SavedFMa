...
void MetPlotAllCent5Bin_RandomCone(char *inputFile="data.root")
{
   ...
   drawText("PYTHIA+HYDJET Truth",0.33,0.82);
   ...
   gPad->RedrawAxis();
   c1->cd(2);
   balanceMetVsAj("../ntv6_data50v2mix1_djcalo_100_50_c0to30_offset1.root","cent<30","",false);
   drawText("CMS",0.33,0.9);
   drawText("0-30%",0.8,0.9);
   drawText("Random Cone (Jet Sample)",0.35,0.83);
   ...
   c1->cd(4);
   balanceMetVsAj("../ntv6_datambv3mix1_djcalo_c0to30.root","cent<30","",false);
   drawText("CMS",0.06,0.90);
   drawText("0-30%",0.8,0.93);
   drawText("Random Cone (MB Sample)",0.35,0.86);
   drawText("(d)",0.04,0.95);
   gPad->RedrawAxis();
   
   c1->SaveAs("missingPtParallel-Corrected-data-RandomCone.eps");
}
