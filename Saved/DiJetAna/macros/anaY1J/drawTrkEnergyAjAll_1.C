...
void drawTrkEnergyAjAll_1(
			  ...
			  Int_t normType=0)
{
  TCanvas *c1 = new TCanvas("c1","",1180,650);
  ...
  c1->cd(1);
  drawTrkEnergy("plot/drawn_jfh"+anaV+"_Hydjet_"+module+"_Cent0to30_Aj0to15_"+BckSub+title+".root",false,true,logScale,normType);
  drawText("A_{J} < 0.15",leftSpace+0.63,0.52);
  ...
  c1->cd(3);
  drawTrkEnergy("plot/drawn_jfh"+anaV+"_Hydjet_"+module+"_Cent0to30_Aj29to100_"+BckSub+title+".root",false,true,logScale,normType);
  drawText("A_{J} > 0.29",0.63,0.52);
  drawText("Leading jet",0.15,downSpace+0.15,15);
  drawText("Sub-leading jet",0.6,downSpace+0.15,15);
  ...
  c1->cd(5);
  drawTrkEnergy("plot/drawn_jfh"+anaV+"_HCPR_J50U_"+module+"_Cent0to30_Aj15to29_"+BckSub+title+".root",false,false,logScale,normType);
  drawText("0.15 < A_{J} < 0.29",0.63,downSpace+0.43);
  drawText("Leading jet",0.15,3*downSpace+0.1,15);
  drawText("Sub-leading jet",0.63,3*downSpace+0.1,15);

  c1->cd(6);
  drawTrkEnergy("plot/drawn_jfh"+anaV+"_HCPR_J50U_"+module+"_Cent0to30_Aj29to100_"+BckSub+title+".root",false,false,logScale,normType);
  drawText("A_{J} > 0.29",0.63,downSpace+0.43);
  drawText("Leading jet",0.15,3*downSpace+0.1,15);
