void balance(TString infile="dj_HCPR-GoodTrkAndPixel_CleanEvt1130.root")
{
  ...
  TH1D * hPNDPhiTrk = new TH1D("hPNDPhiTrk",";#Delta#phi(trk,jet);1/N_{DJ} dp_{T}^{Trk}/d(#Delta#phi#Delta#eta)",10,0,TMath::PiOver2());
  ...
  hPNDPhiPixRB->Rebin(5);
  hPNDPhiTrkRB->Rebin(5);
  hPNDPhiPixRB->Draw("E");
