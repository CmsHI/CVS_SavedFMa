...
root -b -q 'anaJetFrag.C+(0,"S1","'$anaV'","'$module'",0,30,'$NrJEtMin',500,50,500,0.,0.24,'$TrkPtMin',"Ana","'$BkgSub'","'$infileHyd'","Hydjet")'
root -b -q 'anaJetFrag.C+(0,"S1","'$anaV'","'$module'",0,30,'$NrJEtMin',500,50,500,0.24,1.0,'$TrkPtMin',"Ana","'$BkgSub'","'$infileHyd'","Hydjet")'
