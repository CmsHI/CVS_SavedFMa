    ...
    Int_t normType=0)
{
  ...
  drawText("Subleading jet",0.35,downSpace+0.81);
  ...
  drawText("10-30%",0.73,downSpace+0.51);
  ...
  drawText("0-10%",0.73,downSpace+0.51);
  drawText("CMS",0.59,downSpace+0.4);
  drawText("Hydjet",0.22,downSpace+0.4);
  drawText("+PYTHIA",0.19,0.42);

  c1->Print(anaV+"_"+BckSub+title+"TrackEnergyPtRBkgSubCentAll32_dataMC"+drawV+Form("_norm%d.gif",normType));
  c1->Print(anaV+"_"+BckSub+title+"TrackEnergyPtRBkgSubCentAll32_dataMC"+drawV+Form("_norm%d.eps",normType));
  c1->Print(anaV+"_"+BckSub+title+"TrackEnergyPtRBkgSubCentAll32_dataMC"+drawV+Form("_norm%d.C",normType));
}
