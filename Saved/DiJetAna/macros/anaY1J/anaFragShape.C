void anaFragShape(TString infile="dj_HCPR-GoodTrkAndPixel_CleanEvt1130.root")
{
  ...
  TH1D * hPNDRTrk = new TH1D("hPNDRTrk",";#DeltaR(trk,jet);1/N_{DJ} dp_{T}^{Trk}/d(#Delta#phi#Delta#eta)",10,0,TMath::PiOver2());
  TH1D * hPNDRPix = new TH1D("hPNDRPix",";#DeltaR(trk,jet);1/N_{DJ} dp_{T}^{Trk}/d(#Delta#phi#Delta#eta)",10,0,TMath::PiOver2());
  TH1D * hPADRTrk = new TH1D("hPADRTrk",";#DeltaR(trk,jet);1/N_{DJ} dp_{T}^{Trk}/d(#Delta#phi#Delta#eta)",10,0,TMath::PiOver2());
  TH1D * hPADRPix = new TH1D("hPADRPix",";#DeltaR(trk,jet);1/N_{DJ} dp_{T}^{Trk}/d(#Delta#phi#Delta#eta)",10,0,TMath::PiOver2());
  ...
  hPNDRPix->SetMinimum(0.01);
  hPNDRPix->SetMaximum(2000);
  hPNDRTrk->SetMinimum(0.01);
  ...
  hPADRPix->SetMinimum(0.01);
  hPADRPix->SetMaximum(500);
  hPADRTrk->SetMinimum(0.01);
  hPADRTrk->SetMaximum(700);
