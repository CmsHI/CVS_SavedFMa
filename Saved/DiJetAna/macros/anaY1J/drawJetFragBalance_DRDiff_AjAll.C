    ...
    Int_t normType=1)
{
  ...
  c1->cd(1);
  drawJetFragBalance_DRDiff("jfh"+anaV+"_HCPR_J50U_"+module+"_Cent0to30_Aj0to22_"+BckSub+".root",
                            "jfh"+anaV+"_Hydjet_"+module+"_Cent0to30_Aj0to22_"+BckSub+".root",0,0,1);
  drawText("0-30%",0.86,0.9);
  drawText("A_{J}<0.22",0.35,downSpace+0.52);

  drawPatch(-0.00007,0.0972,0.0518,0.171);
  drawPatch(0.976,0.0972,1.1,0.141);
  
  c1->cd(2);
  drawJetFragBalance_DRDiff("jfh"+anaV+"_HCPR_J50U_"+module+"_Cent0to30_Aj22to100_"+BckSub+".root",
                            "jfh"+anaV+"_Hydjet_"+module+"_Cent0to30_Aj22to100_"+BckSub+".root",0,0,0);
  ...
  drawText("A_{J}>0.22",0.11,downSpace+0.52);
  drawPatch(-0.00007,0.0972,0.0518,0.171);


  c1->Print("RocketProjectionDR_v1.gif");
  c1->Print("RocketProjectionDR_v1.eps");
  c1->Print("RocketProjectionDR_v1.C");
