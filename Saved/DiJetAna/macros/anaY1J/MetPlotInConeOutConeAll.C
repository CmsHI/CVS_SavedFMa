...
void MetPlotInConeOutConeAll(char *inputFile="data.root")
{
   //=============================================================
   // MC
   //=============================================================
   ...
   c1->SaveAs("missingPtParallel-Corrected-data-InConeOutConeAll.eps");
   c1->SaveAs("missingPtParallel-Corrected-data-InConeOutConeAll.gif");
}
