...
BkgSub="EtaRefl" # EtaRefl, EtaReflSingle, PhiRot
...
for module in djcalo djcalo_genp; do
  ...
  ./runAnaJetFragHI.sh dj_HydQ_DJUQ80_hiGoodMergedTracks_VtxPatch_v1_OfficialSelv3_${module}_120_50.root Hydjet $anaV $module 0 $BkgSub
  ./runAnaJetFragHI.sh dj_HydQ_DJUQ80_hiGoodMergedTracks_VtxPatch_v1_OfficialSelv3_${module}_120_50.root Hydjet ${anaV}ReWt $module 1 $BkgSub
