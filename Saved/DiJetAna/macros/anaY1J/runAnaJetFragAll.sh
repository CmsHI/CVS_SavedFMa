...
#  done
  ...
  for module in djcalo_genp; do
    ./runAnaJetFragHI.sh dj_HyUQ80v3_${module}_120_50.root HydjetSig ${anaV}ReWtRawEta $module 1 $BkgSub 0
    ./runAnaJetFragHI.sh dj_HyUQ80v4_${module}_120_50.root HydjetAll ${anaV}ReWtRawEta $module 1 $BkgSub 0
  done
