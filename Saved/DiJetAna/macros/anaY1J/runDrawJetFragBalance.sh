...
root -b -q $macro'+("jfh'$anaV'_PyquenUQ80_'$module'_Cent0to100_Aj0to24_'$BkgSub'.root","'$Title'")'
root -b -q $macro'+("jfh'$anaV'_PyquenUQ80_'$module'_Cent0to100_Aj24to100_'$BkgSub'.root","'$Title'")'

root -b -q $macro'+("jfh'$anaV'_HCPR_J50U_'$module'_Cent0to30_Aj0to24_'$BkgSub'.root","'$Title'")'
root -b -q $macro'+("jfh'$anaV'_HCPR_J50U_'$module'_Cent0to30_Aj24to100_'$BkgSub'.root","'$Title'")'

root -b -q $macro'+("jfh'$anaV'_Hydjet_'$module'_Cent0to30_Aj0to24_'$BkgSub'.root","'$Title'")'
root -b -q $macro'+("jfh'$anaV'_Hydjet_'$module'_Cent0to30_Aj24to100_'$BkgSub'.root","'$Title'")'
