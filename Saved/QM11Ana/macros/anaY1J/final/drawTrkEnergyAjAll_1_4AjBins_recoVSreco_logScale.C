...
void drawTrkEnergyAjAll_1_4AjBins_recoVSreco_logScale(
    TString anaV="v20", // for paper: v18
    TString anaV2="v20", // for paper: v18, MB+Jet v20RandomConeReWt
    TString module="djcalo",
    TString module2="akpu3pf",
    ...
    Int_t normType=0)
{
  ...
  drawText("CMS Published",0.33,0.81);
  ...
  c1->cd(5);
  drawTrkEnergy("jfh"+anaV2+"_"+src2+"_"+module2+"_Cent0to30_Aj0to11_"+BckSub+".root",false,true,logScale,normType,0);
  ...
  drawText("Jet35U",0.31,0.8);//,12);
  drawText(module2,0.31,0.73);//,12);
  //drawText("Excluded Dead Pix Region",0.31,0.73,12);
  drawText("0-30%",0.32,downSpace+0.56);

  c1->cd(6);
  drawTrkEnergy("jfh"+anaV2+"_"+src2+"_"+module2+"_Cent0to30_Aj11to22_"+BckSub+".root",false,false,logScale,normType,0);
  ...
  c1->cd(7);
  drawTrkEnergy("jfh"+anaV2+"_"+src2+"_"+module2+"_Cent0to30_Aj22to33_"+BckSub+".root",false,false,logScale,normType,0);
  ...
  c1->cd(8);
  drawTrkEnergy("jfh"+anaV2+"_"+src2+"_"+module2+"_Cent0to30_Aj33to100_"+BckSub+".root",false,false,logScale,normType,0);
