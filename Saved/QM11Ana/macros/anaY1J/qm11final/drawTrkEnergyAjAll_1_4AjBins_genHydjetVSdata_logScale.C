    ...
    Int_t normType=0)
{
  ...
  c1->cd(1);
  drawTrkEnergy(pref+anaV+"ReWt_"+mcSrc+"_"+module+"_"+centBin+"_Aj0to13_"+BckSub+".root",false,true,logScale,normType,0);
  ...
  c1->cd(2);
  drawTrkEnergy(pref+anaV+"ReWt_"+mcSrc+"_"+module+"_"+centBin+"_Aj13to24_"+BckSub+".root",false,true,logScale,normType,0);
  ...
  c1->cd(3);
  drawTrkEnergy(pref+anaV+"ReWt_"+mcSrc+"_"+module+"_"+centBin+"_Aj24to35_"+BckSub+".root",true,true,logScale,normType,0);
  ...
  c1->cd(4);
  drawTrkEnergy(pref+anaV+"ReWt_"+mcSrc+"_"+module+"_"+centBin+"_Aj35to70_"+BckSub+".root",false,true,logScale,normType,0);
