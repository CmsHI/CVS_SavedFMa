...
void MetPlotAllCent5Bin(char *inputFile="data.root")
{
   ...
   c1->cd(1);
   balanceMetVsAj("../ntout/nt_tranav5_2_hydjuq80v5_akpu3pf_t0_offset0.root","cent>=30","",false,false);
   ...
   c1->cd(2);
   balanceMetVsAj("../ntout/nt_tranav5_2_hydjuq80v5_akpu3pf_t0_offset0.root","cent<30","",true,false);
   ...
   c1->cd(3);
   TCut phiSysCut;
   balanceMetVsAj("../ntout/nt_tranav5_2_datamattpfv2_akpu3pf_hiGood_offset0.root","cent>=30","",false);
   //balanceMetVsAj("../ntout/nt_tranav5_2_hydjuq80v5_akpu3pf_t2_offset0.root","cent>=30","",false);
   ...
   c1->SaveAs("missingPtParallel-Corrected-data-akpu3pf-allCent.eps");
   c1->SaveAs("missingPtParallel-Corrected-data-akpu3pf-allCent.gif");
}
