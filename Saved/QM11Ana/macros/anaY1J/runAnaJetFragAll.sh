...
for BkgSub in "EtaReflSingle"; do # paper: EtaReflSingle
  ...
  #for module in icpu5 akpu3pf; do
  for module in akpu3pf; do
    ./runAnaJetFragHI.sh tranav3_datamattpfv1_${module}_hiGoodMerged.root HAZS_J35U $anaV $module 0 $BkgSub 0
