...
void drawTrkCorrPt(Int_t corrLevel=0,
    TString mod="hitrkEffAnalyzer_akpu3pf_j1",
    ...
    )
{
  ...
  // eff
  TH1D * hCorrPtRefJet100 = (TH1D*) trkCorrRef.InspectCorr(0,2,centBeg,centEnd,8,16,2,7-etaPM,7+etaPM);
  ...
  TH1D * hCorrPtJet40 = (TH1D*) trkCorr.InspectCorr(0,3,centBeg,centEnd,8,16,2,7-etaPM,7+etaPM);
  hCorrPtJet40->Draw("same E");

  // fake
  TH1D * hCorr1PtRefJet100 = (TH1D*) trkCorrRef.InspectCorr(1,2,centBeg,centEnd,8,16,2,7-etaPM,7+etaPM);
  hCorr1PtRefJet100->SetMarkerStyle(kOpenCircle);
  hCorr1PtRefJet100->Draw("sameE");
  TH1D * hCorr1PtJet40 = (TH1D*) trkCorr.InspectCorr(1,3,centBeg,centEnd,8,16,2,7-etaPM,7+etaPM);
  ...
  leg->AddEntry(hCorrPtRefJet100,"Leading Jet, p_{T} > 140 GeV/c, #hat{p}_{T}>80GeV","p");
  leg->AddEntry(hCorrPtJet40,"Leading Jet, p_{T} > 140 GeV/c, #hat{p}_{T}>110GeV","p");
  leg->Draw();
