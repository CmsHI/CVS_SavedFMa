    ...
    )
{
  ...
  TH1D * hJEtIc5puJ35U = plotJEt(mbdj,evtSelMB&&"HLT_HIJet35U","recoJetCalPt[0]","hJEtIc5puJ35U",0);
  TH1D * hJEtIc5puJ50U = plotJEt(mbdj,evtSelMB&&"HLT_HIJet50U","recoJetCalPt[0]","hJEtIc5puJ50U",0);
  ...
  cpJEt.AddHist1D(hJEtIc5pu,"HLT_HIMinBiasHfOrBSC_Core","E",kBlack,kFullCircle);
  cpJEt.AddHist1D(hJEtIc5puJ35U,"HLT_HIJet35U_Core","E",kBlue,kOpenCircle);
  cpJEt.AddHist1D(hJEtIc5puJ50U,"HLT_HIJet50U_Core","E",kRed,kOpenSquare);
  cpJEt.SetLegend(0.48,0.78,0.80,0.9);
