...
TChain * trigEff(
    ...
    TString infile="~/scratch01/ana/HCPR-GoodRuns-151027and151058_mb1123/merge/dj_HCPR-MB-151027and151058_mb1123.root",
    TString header="HLT_HIJet50U_Core, |#eta|<3",
    TString var="nljet",
    TString Tag="Corr"
    )
{
  ...
  g0 = eff(dj,var,evtSel,"hlt[2]","ic5pu");
  ...
  //g2->SetLineColor(kRed); g2->SetMarkerColor(kRed); g2->SetMarkerStyle(kOpenCircle);
  //g3->SetMarkerColor(kBlue); g3->SetLineColor(kBlue); g3->SetMarkerStyle(kOpenStar);
  //g4->SetMarkerStyle(kOrange); g4->SetLineStyle(kOrange); g4->SetMarkerStyle(kOpenDiamond);
  hTmp->SetAxisRange(0,1.3,"Y");
  hTmp->SetXTitle("Leading E_{T}^{Jet,"+Tag+"} [GeV]");
  ...
  t->Draw();
  addCms(cTrigEff);
  cTrigEff->Print("TrigEff"+Tag+"ected151058and151025.gif");
  cTrigEff->Print("TrigEff"+Tag+"ected151058and151025.eps");
  cTrigEff->Print("TrigEff"+Tag+"ected151058and151025.pdf");
  cTrigEff->Print("TrigEff"+Tag+"ected151058and151025.C");
