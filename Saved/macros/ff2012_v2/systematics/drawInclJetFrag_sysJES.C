...
//     dj->AddFriend("mGenPar");
  ...
  dj->SetAlias("finalJetPt","(jetPt*(0.949+0.051*cBin/40.))"); // systematic check for uncertainty in jes
...
//     }
  ...
  TString outnameTag=Form("trackPtCut%.0f_FinalJetPt%.0fto%.0feta%.2f_Jan17data_and_mc80and100_sysjes5.1",ptranges[0],finalJetPtMin,finalJetPtMax,finalEtaCut);
