...
// Main Function --------------------------------------------------------------------
void drawInclJetFrag_sysJetThreshold() {
  /////////////////////////////////////////////////////////////////
...
//     }
  ...
  TString outnameTag=Form("trackPtCut%.0f_FinalJetPt%.0fto%.0feta%.2f_Jan17data_and_mc80and100",ptranges[0],finalJetPtMin,finalJetPtMax,finalEtaCut);
