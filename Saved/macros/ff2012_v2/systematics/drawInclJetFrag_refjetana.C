...
// Main Function --------------------------------------------------------------------
void drawInclJetFrag_refjetana() {
  /////////////////////////////////////////////////////////////////
...
//     }
  ...
  TString outnameTag=Form("trackPtCut%.0f_FinalJetPt%.0fto%.0feta%.2f_Feb14v2_mc80to170_refjetana_hi_pp",ptranges[0],finalJetPtMin,finalJetPtMax,finalEtaCut);
