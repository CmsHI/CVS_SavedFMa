...
void mergeForest_mc(){
   ...
   const char* fname = "/mnt/hadoop/cms/store/user/yetkin/MC_Production/Hydjet18/HiForest_v7/*.root";
   TString outfname="/net/hidsk0001/d00/scratch/frankma/tmp/HiForest_Hydjet18_MinBias_v7.root";
