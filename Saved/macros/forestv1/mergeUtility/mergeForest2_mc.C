...
void mergeForest2_mc(){

   const char* fname = "/mnt/hadoop/cms/store/user/yetkin/MC_Production/Pythia80_HydjetDrum_mix01/HiForest2_v19/set1_random1000*.root";
   TString outfname="/net/hidsk0001/d00/scratch/frankma/tmp/HiForest-hy18dj80-HiForest2_v19.root";
