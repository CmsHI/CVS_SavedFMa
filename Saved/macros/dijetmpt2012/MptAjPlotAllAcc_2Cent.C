...
//    
   c1->cd(1);
   balanceMetVsAj(inputFile_peripheral,"hi",Form("trkAllAcc"),false);
   ...
   drawText("#intL dt = 50 #mub^{-1}",0.33,0.78);
   drawText(" 30-100%",0.85,0.93);
//    drawText("(c)",0.31,0.95);
   gPad->RedrawAxis();
   
   c1->cd(2);
   balanceMetVsAj(inputFile_central,"hi",Form("trkAllAcc"),false);
   drawText("0-30%",0.7,0.93);
//    drawText("(d)",0.04,0.95);
   gPad->RedrawAxis();
   
   c1->SaveAs(Form("fig/05.16_hgt/missingPtParallel-TrkAlgo4HP-UnCorr-data-mcGen-AllAcc.pdf"));
   c1->SaveAs(Form("fig/05.16_hgt/missingPtParallel-TrkAlgo4HP-UnCorr-data-mcGen-AllAcc.gif"));
}
