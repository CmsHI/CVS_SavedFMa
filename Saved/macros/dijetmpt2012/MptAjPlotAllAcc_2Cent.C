...
const int nBin = 6;
float bins[nBin+1]={0.5,1.0,2,4,8,20,200};
...
//         cout << hname << " Aj bin: " << a+1 << " mean: " << hMpt->GetMean() << endl;
         ...
         if (doResCorr) {
            if (i==nBin-1) mpt*=0.8;
            if (i==nBin) mpt-=(pe[nBin-1]->GetBinContent(a+1)*0.2);
         }
...
//    TString inputFile_central="fig/04.25_datapixtrk/HisOutput_DiJetv7_v4_icPu5_Mpt_120_50_2749_Norm0_c0_12.root";
//    TString inputFile_peripheral="fig/04.25_datapixtrk/HisOutput_DiJetv7_v4_icPu5_Mpt_120_50_2749_Norm0_c12_40.root";
//    TString inputFile_central="fig/05.16_hgt/HisOutput_DiJetTrkv0_v9_icPu5_Mpt_120_50_2094_Norm0_c0_12.root";
//    TString inputFile_peripheral="fig/05.16_hgt/HisOutput_DiJetTrkv0_v9_icPu5_Mpt_120_50_2094_Norm0_c12_40.root";
//    TString inputFile_central="fig/05.16_hgt/HisOutput_DiJetTrkv0_v9_icPu5_trkAlgo4HP_120_50_2094_c0_12.root";
//    TString inputFile_peripheral="fig/05.16_hgt/HisOutput_DiJetTrkv0_v9_icPu5_trkAlgo4HP_120_50_2094_c12_40.root";
//    TString inputFile_central="fig/05.16_hgtcorr/HisOutput_DiJetTrkv0_v9_icPu5_trkAlgo4HPCorr_120_50_2094_c0_12.root";
//    TString inputFile_peripheral="fig/05.16_hgtcorr/HisOutput_DiJetTrkv0_v9_icPu5_trkAlgo4HPCorr_120_50_2094_c12_40.root";
...
//    TString inputFile_Py="fig/04.18_pythia_reco_gen/HisOutput_DiJetv7_v4_icPu5_Mpt_120_50_2749_Norm0_c0_40.root";
   TString inputFile_central_mc="fig/06.13MptClos/HisMc_icPu5_trkHPCorr_120_50_2094_eta2_c0_12.root";
   TString inputFile_peripheral_mc="fig/06.13MptClos/HisMc_icPu5_trkHPCorr_120_50_2094_eta2_c12_40.root";
   TString inputFile_central="fig/06.13MptClos/HisData_icPu5_trkHPCorr_120_50_2094_eta2_c0_12.root";
   TString inputFile_peripheral="fig/06.13MptClos/HisData_icPu5_trkHPCorr_120_50_2094_eta2_c12_40.root";
...
//    makeMultiPanelCanvas(c1,2,1,0.0,0.0,leftMargin,bottomMargin,0.02);
   ...
   c1->cd(1);
//    balanceMetVsAj(inputFile_Py,"hypho",Form("genpSigAllAcc"),false,false);
//   balanceMetVsAj(inputFile_Py,"hypho",Form("trkCorrAllAcc"),false,false);
   balanceMetVsAj(inputFile_peripheral_mc,"hypho",Form("trkCorrAllAcc"),false,false);
...
//    drawText("PYTHIA Signal",0.33,0.82);
   ...
   c1->cd(2);
//   balanceMetVsAj(inputFile_Py,"hypho",Form("genpSigAllAcc"),true,false);
   balanceMetVsAj(inputFile_central_mc,"hypho",Form("trkCorrAllAcc"),true,false);
...
//    drawText("#Delta#phi_{1,2}>  #frac{5}{6}#pi",ptx,pty1-0.14);
   ...
   c1->cd(3);
   balanceMetVsAj(inputFile_peripheral,"hi",Form("trkCorrAllAcc"),false,false);
...
//    drawText("(c)",0.31,0.95);
   ...
   c1->cd(4);
   balanceMetVsAj(inputFile_central,"hi",Form("trkCorrAllAcc"),false,false);
