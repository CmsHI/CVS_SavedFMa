...
{
//    TString inputFile_central="fig/05.07_mptclosure2/HisOutput_DiJetv7_v6_icPu5_Mpt_120_50_2749_Norm0_c0_12.root";
   TString inputFile_central="fig/05.10_chi2/HisOutput_DiJetTrkv0_v7_icPu5_Mpt_120_50_2749_Norm0_c0_12.root";
   TString inputFileMc_central="fig/05.07_mptclosure2/HisOutput_Hy18DJv1_v6_icPu5_Mpt_120_50_2749_Norm0_c0_12.root";
   ...
   c1->cd(1);
   balanceMetVsAj(inputFile_Py,"hypho",Form("genpSigInCone%.0f",coneSize*10),false,false);
   ...
   c1->cd(2);
   balanceMetVsAj(inputFile_Py,"hypho",Form("genpSigOutCone%.0f",coneSize*10),false,false);
   ...
   c1->cd(3);
   TCut phiSysCut;
//    balanceMetVsAj(inputFileMc_central,"hypho",Form("trkCorrInCone%.0f",coneSize*10),false);
   balanceMetVsAj(inputFile_central,"hi",Form("trkCorrInCone%.0f",coneSize*10),false);
   ...
   c1->cd(4);
//    balanceMetVsAj(inputFileMc_central,"hypho",Form("trkCorrOutCone%.0f",coneSize*10),false);
   balanceMetVsAj(inputFile_central,"hi",Form("trkCorrOutCone%.0f",coneSize*10),false);
   drawText("Out-of-Cone",0.7,0.93);
   drawText(Form("#DeltaR#geq%.1f",coneSize),0.7,0.93-0.06);
   drawText("(d)",0.04,0.95);
   gPad->RedrawAxis();
   
//    c1->SaveAs(Form("missingPtParallel-Corr-data-mcGen-InCone%.0fOutCone.pdf",coneSize*10));
//    c1->SaveAs(Form("missingPtParallel-Corr-data-mcGen-InCone%.0fOutCone.gif",coneSize*10));
}
