...
void drawInclJetResultSys_Overlay_JetPt(int fragMode= 2, // 1=trkpt, 2=ff
...
{ 
  ...
  TString tag = Form("trkPtProj_binMode2_JetPt130to140_hi_rewt%d_pp_sm%drewt%d_bc%d",jtrewthi,ppsm,jtrewtpp,biascorr);
  // tag+="_eta1.2";
  ...
  // Specify Inputs
  //////////////////////////////////////////////////////////////////////
  // std::string Input_=Form("inclJetFF_output_trackPtCut1_FinalJetPt130to140eta2.00_jdr0.3_Mar19job0_data_mc80to170_hi_pp_corrjbias%d_v3.root",biascorr);
  // std::string Inputpp_=Form("inclJetFF_output_trackPtCut1_FinalJetPt130to140eta2.00_jdr0.3_Mar19job0_data_mc80to170_hi_pp_corrjbias%d_v3.root",biascorr);
  std::string Input_=Form("inclJetFF_output_trackPtCut1_FinalJetPt130to140eta2.00_jdr0.3_Mar19job0_data_mc80to170reco_hi_pp_corrjbias%d_v3.root",biascorr);
  std::string Inputpp_=Form("inclJetFF_output_trackPtCut1_FinalJetPt130to140eta2.00_jdr0.3_Mar19job0_data_mc80to170reco_hi_pp_corrjbias%d_v3.root",biascorr);
  
  // mc
  if (doMC) {
    Input_=Form("inclJetFF_output_trackPtCut1_FinalJetPt130to140eta2.00_jdr0.3_Mar19job0_data_mc80to170_hi_pp_corrjbias%d_v3.root",biascorr);
    Inputpp_=Form("inclJetFF_output_trackPtCut1_FinalJetPt130to140eta2.00_jdr0.3_Mar19job0_data_mc80to170_hi_pp_corrjbias%d_v3.root",biascorr);
  ...
  for ( int iaj=1 ; iaj<=4 ; iaj++) {
    ...
    if (iaj==1) {
      ...
      drawText(Form("Jet 130 < p_{T}  < 140 GeV/c"),ptx,pty1,kBlack,25);
