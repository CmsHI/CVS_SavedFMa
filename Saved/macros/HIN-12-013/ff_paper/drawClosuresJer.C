...
void drawClosuresJer() {
  TH1::SetDefaultSumw2();

  // Setup
  int ijet=1;
  TString infname,reffname;
  Plot4x4::title1="JES*1.08";
  Plot4x4::title2="JER*1";
  // Inputs
  // data
  infname = "inclJetFF_output_trackPtCut1_FinalJetPt100to300eta2.00_Jan17data_hism3.root";
  reffname  = "inclJetFF_output_trackPtCut1_FinalJetPt100to300eta2.00_Jan17data_hi_pprewt.root";
  Plot4x4::outpath="closure/data_sysjer";
