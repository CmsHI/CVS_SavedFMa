...
const int kHighPtTrack = 0;
const int kLowPtTrack = 1;
...
class HiForest : public TNamed
{
  ...
  // Eventlan filtering utility functions
  bool selectEvent();
  TCut eventSelection();
...
void HiForest::InitTree()
{
   ...
   if(doTrackCorrections){ 	 
	...
	trackCorrections.push_back(new TrackingCorrections("trkCorrHisAna_qcdAllPhoton","_v1","hitrkEffAnalyzer_GeneralCalo"));
	trackCorrections.push_back(new TrackingCorrections("trkCorrHisAna_qcdAllPhoton","_v1","hitrkEffAnalyzer_PixTrk"));
      } 	 
      
      trackCorrections[kHighPtTrack]->isLeadingJet_ = 0; 	 
      trackCorrections[kLowPtTrack]->isLeadingJet_ = 0; 	 
