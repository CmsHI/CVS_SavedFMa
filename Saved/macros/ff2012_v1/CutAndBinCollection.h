...
double taa[4]       = {0,          23.2e-6,          11.6e-6,           1.45e-6};  // nano barn         
...
const int nEtBin = 5;
double etBin[nEtBin+1] = {30,35,40,50,70,120};
const int nCent_std = 3;
double centBin_std[nCent_std+1] = {0,4,12,40};
