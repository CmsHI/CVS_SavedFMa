...
//    TString infdataname = "fig/06.30_MPT0StudyDataMC/HisMc_icPu5_trkHPCorr_120_50_2749_eta24_prec4_JetSelEta3TrkCorrDiffLSL.root";
   ...
   TString tag = Form("compMptMc_JetSelEta3_"+insrc);
