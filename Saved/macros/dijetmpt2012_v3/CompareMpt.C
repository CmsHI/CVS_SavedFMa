...
//    TString infrefname="fig/06.26_tree/HisMc_icPu5_trkHPCorr_120_50_2749_eta24_prec4.root";
   TString infdataname="fig/06.26_tree/HisMc_icPu5_trkHPCorr_120_50_2749_eta24_prec0.root";
   TString infrefname="fig/06.28_genp/HisMc_icPu5_trkHPCorr_120_50_2749_eta24_prec0_bkgp.root";
   ...
   TString tag = Form("compMptEta24Bkgp_"+insrc);
   ...
   // Legend
   TString titledata = "Gen. Partl. Sig+Bkg (|#eta|<2.4)";
   TString titleref  = "Gen. Partl. Bkg (|#eta|<2.4)";
