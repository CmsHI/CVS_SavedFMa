...
void analyze_self(char * infile = "/home/yilmaz/analysis/jets/4TeV/corrected/pythia_dijet_pt80to120_hydjet_mb_4TeV_d20090615/run2/pre.root"){
   ...
   TTree* treco = dynamic_cast<TTree*>(tsub->Clone("hi2"));
   ...
   //=== Start from this point all created TObjects will be saved to outf
