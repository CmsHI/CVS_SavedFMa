...
//--- Set Histogram ---
void setHist(TH1* h, const Color_t lc=0, const Style_t ls=0, const Width_t lw=0, const Size_t msz=0, const int mst=0, const double norm = -1, const char* xtitle = "", const char* ytitle = "", const double ymax=0)
{
...
void setHist(const char* name, const Color_t lc=0, const Style_t ls=0, const Width_t lw=0, const Size_t msz=0, const int mst=0, const double norm = -1, const char* xtitle = "", const char* ytitle = "", const double ymax=0)
{
   TH1F * h;
...
Float_t drawTree(TTree* nt, const char* draw, const char* cut, const char* opt, const char* name, const char* title, const int nbin, const float min, const float max, bool log=false, const Color_t lc=0, const Style_t ls=0, const Width_t lw=0, const Size_t msz =0, const int mst =0, float norm=-1.,const double ymax=0)
{
   //--- Print some info ---
...
void drawDivHist(const char* hn1, const char* hn2, const char* opt, const char* name, const char* title, const int nbin, const float min, const float max, bool log=false, const Color_t lc=0, const Style_t ls=0, const Width_t lw=0, const Size_t msz=0, const int mst=0, const float ymax=0)
{
   // find input histos
   if (!TString(opt).Contains("same")) printf("\n");
...
void drawNormHist(TH1* h, const char* opt="", const char* title="", const char* xtitle = "", const char* ytitle = "", const double norm = -1, bool log = false, const Color_t lc=0, const Style_t ls=0, const Width_t lw=0, const Size_t msz=0, const int mst=0, const double ymax=0)
{
...
void drawNormHist(const char* hn, const char* opt="", const char* title="", const char* xtitle = "", const char* ytitle = "", const double norm = -1, bool log = false, const Color_t lc=0, const Style_t ls=0, const Width_t lw=0, const Size_t msz=0, const int mst=0, const double ymax=0)
{
   TH1 * h;
...
TH1 * drawNormHist(TFile * f, const char* hn, const char* opt="", const char* title="", const char* xtitle = "", const char* ytitle = "", const double norm = -1, bool log = false, const Color_t lc=0, const Style_t ls=0, const Width_t lw=0, const Size_t msz=0, const int mst=0, const double ymax=0)
{
   TH1 * h;
   if (f->Get(hn))
...
TH1 * drawIntHist(const char* hinName, const char* houtName, const char* opt="", const char* title="", const char* xtitle = "", const char* ytitle = "",
                 const double norm = -1, int log = 0, const Color_t lc=0, const Style_t ls=0, const Width_t lw=0, const Size_t msz=0, const int mst=0,
		 const double ymax=0)
{
