...
process.load('CmsHi.Validation.ValidationHeavyIons_cff')
...
# test only jet HLT for now
process.validationHeavyIons = cms.Sequence(process.SingleJetPathVal35)
process.SingleJetPathVal35.WriteFile = cms.untracked.bool(True)
