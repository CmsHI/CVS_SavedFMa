...
//     if(cfg->pnames[i]=="zee"||cfg->pnames[i]=="zmumu"){
    if(cfg->pisPhysicsSample[i]!=0){
      ...
      TNtuple *ntlead = new TNtuple("ntlead","Leading phy obj","genpt:geneta:genphi:recpt:receta:recphi:l1pt:l1j15:l1j30:l1j50:hltbit:recdphi:recdphigen2:recdr:recdrgen2");
