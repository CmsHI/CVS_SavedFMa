...
//  void Clear(){}
  ...
  void AddHist1D(TH1F *h, TString label, TString drawopt, int color=kBlack, int linesty=1, int mksty=20, int fillsty=0);
  void AddHist1D(TFile *f, TString histName, TString drawopt="", int color=kBlack, int linesty=1, int mksty=20, int fillsty=0);
  void AddHist1D(TFile *f, TString histName, TString label, TString drawopt, int color=kBlack, int linesty=1, int mksty=20, int fillsty=0);
