...
void hisTGroupDriver()
{
  ...
  hgSpec.H("PSJ0Pt")->SetMarkerColor(kRed);
  ...
  hgTestSum.R("Sum")->SetMarkerStyle(kOpenSquare);
  hgTestSum.R("Sum")->Draw("E");
  hgTestSum.H("h1")->Draw("same hist");
  hgTestSum.H("h2")->Draw("same hist");
  ...
  hgTestAve.H("h1")->Draw("hist");
  hgTestAve.R("Ave")->SetMarkerStyle(kOpenSquare);
  hgTestAve.R("Ave")->Draw("sameE");
  hgTestAve.H("h2")->Draw("same hist");

  // Test Sum 2d
  HisTGroup<TH2D> hgTestSum2D("TestSum2D",10,0,10,10,0,10);
  hgTestSum2D.Add(hgDj2.H("NrAw"),"NrAw");
  hgTestSum2D.Add2D("NrAw2");
  hgTestSum2D.H("NrAw2")->Fill(1,1);
  hgTestSum2D.H("NrAw2")->Fill(1,1);
  hgTestSum2D.H("NrAw2")->Fill(1,2);
  hgTestSum2D.Print();
  hgTestSum2D.Sum();
