...
process.hltTowerMakerForEcal = cms.EDProducer( "CaloTowersCreator",
    ...
    hbheInput = cms.InputTag( "nohltHbhereco" ),
    hoInput = cms.InputTag( "nohltHoreco" ),
    hfInput = cms.InputTag( "nohltHfreco" ),
...
process.hltHI1jet35U = cms.EDFilter( "HLTCaloTowerFilter",
...
process.HLT_EcalActivity1 = cms.Path( process.HLTBeginSequence + process.HLTDoCaloSequence + process.hltTowerMakerForEcal + process.hltHI1jet35U + process.HLTEndSequence )
