#!/bin/bash -
#command line: create_custom_cfg.sh ../../cfg/special/test/OnLine_HLT_Test.py ../../cfg/addHLT_EcalActivity.py ../../cfg/addHLT_PixelActivity.py ../../custom_essource.py ../../mycustom_options.py
add_custom_cfg.sh ../../cfg/special/test/OnLine_HLT_Test.py ../../cfg/addHLT_EcalActivity.py
