    ...
    //const char * mc2fname="pixelTree_Phojet_MinBias_900GeV_d20100108.root")
{
  ...
  */
  ...
  leg2->AddEntry(hEaddEpPos_data,"Data 7TeV (Run 132440)","p");
  leg2->AddEntry(hEaddEpPos_pythia,Form("default pythiaD6t %s",etype[evtType].Data()),"p");
